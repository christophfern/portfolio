...
function TechnicalBlog() {
  ...
  useEffect(() => {
        fetch(apiUrl(ApiEnum.GET_TECHNICAL_BLOG))
          .then((res) => res.json())
    ...
    <div className="bg-primary-100 min-h-screen p-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-accent-300 p-8 rounded-lg shadow-lg mb-8">
          <h2 className="text-xl font-bold text-black text-center mb-4">Welcome to the Technical Articles section</h2>
          <p className="text-black">
            Here you will find a collection of technical articles covering a wide range of topics, from programming and
